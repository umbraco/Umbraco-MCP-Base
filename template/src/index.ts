...
// from the `info.version` of whatever OpenAPI spec `orval.config.ts` points at.
// Regenerate against a newer Umbraco and the constant follows automatically;
// there is nothing to keep in sync by hand. `UMBRACO_EXPECTED_MAJOR` /
